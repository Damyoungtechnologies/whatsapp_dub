...
if(isset($_POST['submit'])){
    ...
    if(empty($id) && empty($user_name) && empty($phone_number) && empty($password)){
        ...
        $crude = "UPDATE insert_new SET  user_name = '$user_name', phone_number = '$phone_number', password ='$password' WHERE id = '$id'";
...
<body>
    <div class="me">
        ...
        <div class="insert">
            <div class="first">UPDATE FORM</div>
            ...
            <button class="update" name="submit" type="submit">Update now!</button>
            </form>
