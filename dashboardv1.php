...
<?php
  ...
  $newdata = "SELECT * FROM dlcf_register WHERE id = '$userid'";
  $newdataresult = mysqli_query($db, $newdata);
  $resultnew = mysqli_fetch_array($newdataresult);
?>
...
<body onload="preload()">
    ...
    <header class="dashboard">
        <div class="nav-bar">
            ...
            <div class="online"><div class="damyoung"><img src="images/damyoung_photo.jpg"></div> <h3><?php echo  $resultnew['user_name']; ?> <i class="fa fa-chevron-circle-down" aria-hidden="true"></i></h3>
            <div class="underonline">
                <div class="me"><span class="color"><?php echo  $resultnew['user_name']; ?></span><br> online</div>
                <div class="next">
                    <ul>
        ...
        <div class="side-bar">
        <div class="menu">Menu 
        <?php echo  $resultnew['user_name'] ;  ?></div>
        <div class="list">
            <ul>
        ...
        <?php echo  $resultnew['street_address'] ;  ?>
            ...
            <?php  while($resultnew = mysqli_fetch_array($newdataresult)){ ?>
            <tr>
                <td> <?php echo  $resultnew['id'] ;  ?></td>`
                <td> <?php echo  $resultnew['phone_number'] ;  ?></td>
                <td></td>
                <td></td>
            </tr>
            </table>
